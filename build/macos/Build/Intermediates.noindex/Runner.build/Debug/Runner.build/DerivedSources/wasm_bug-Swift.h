...
#ifndef WASM_BUG_SWIFT_H
#define WASM_BUG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="wasm_bug",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8wasm_bug11AppDelegate")
...
SWIFT_CLASS("_TtC8wasm_bug17MainFlutterWindow")
